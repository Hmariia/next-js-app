...
const Experience = ({ user }) => {
  return (
    <form className={dataStyles.form}>
        ...
        <div className={dataStyles.box} key={index}>
            <div className={dataStyles.formbox}>
                ...
                <input id={dataStyles.name} type="text" value={item.position} key={item.key} disabled/>
            </div>
            <div className={dataStyles.formbox}>
                ...
                <input id={dataStyles.name} type="text" value={item.date} key={item.key} disabled/>
            </div>
            ...
            <div className={dataStyles.formbox} key={index}>
                ...
                <textarea id={dataStyles.name} type="text" value={data.data} key={data.key} disabled/>
            </div>)}
        </div>)}
    </form>
  )
