  ...
  return (
    <div>
        <form className={dataStyles.form}>
            <div className={dataStyles.formbox}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-person-fill" viewBox="0 0 16 16">
                    <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                </svg>
                <input id={dataStyles.name} type="name" value={user.name} disabled/>
            </div>
            <div className={dataStyles.formbox}>
                ...
                <input id={dataStyles.uname} type="name" value={user.username} disabled/>
            </div>
            <div className={dataStyles.formbox}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-envelope" viewBox="0 0 16 16">
                    <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4Zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2Zm13 2.383-4.708 2.825L15 11.105V5.383Zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741ZM1 11.105l4.708-2.897L1 5.383v5.722Z"/>
                </svg>
                <input id={dataStyles.email} type='email' value={user.email} disabled/>
            </div>
            <div className={dataStyles.formbox}>
                ...
                <input id={dataStyles.phone} type='phone' value={user.phone} disabled/>
            </div>
            <div className={dataStyles.formbox}>
                ...
                <input id={dataStyles.website} type='website' value={user.website} disabled/>
            </div>
            <div className={dataStyles.formbox}>
                ...
                <input id={dataStyles.address} type='address' value={user.address?.street} disabled />
            </div>
            <div className={dataStyles.formbox}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-bookmark" viewBox="0 0 16 16">
                    <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.777.416L8 13.101l-5.223 2.815A.5.5 0 0 1 2 15.5V2zm2-1a1 1 0 0 0-1 1v12.566l4.723-2.482a.5.5 0 0 1 .554 0L13 14.566V2a1 1 0 0 0-1-1H4z"/>
                </svg>
                <input id={dataStyles.address} type='address' value={user.address?.suite} disabled />
            </div>
            <div className={dataStyles.formbox}>
                ...
                <input id={dataStyles.city} type='city' value={user.address?.city} disabled />
            </div>
            <div className={dataStyles.formbox}>
                ...
                <input id={dataStyles.country} type='country' value={user.address?.country} disabled />
            </div>
            <div className={dataStyles.formbox}>
                ...
                <input id={dataStyles.zipcode} type='zipcode' value={user.address?.zipcode} disabled />
            </div>
        </form>
    </div>
  )
